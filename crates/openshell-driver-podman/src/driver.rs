...
mod tests {
    ...
    #[test]
    fn validate_sandbox_create_accepts_default_gpu_with_inventory() {
    ...
    #[test]
    fn validate_sandbox_create_accepts_all_only_inventory_when_dxg_fallback_allowed() {
        use openshell_core::proto::compute::v1::DriverSandboxSpec;
    ...
    #[test]
    fn validate_sandbox_create_rejects_all_only_inventory_without_dxg_fallback() {
        use openshell_core::proto::compute::v1::DriverSandboxSpec;
